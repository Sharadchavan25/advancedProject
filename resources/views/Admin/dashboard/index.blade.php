        ...
        <div id="layout-wrapper">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="index.html" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="{{ asset('admin/assets/images/logo-dark.png') }}" alt="logo-sm-dark" height="24">
                                </span>
                                <span class="logo-lg">
                                    <img src="{{ asset('admin/assets/images/logo-sm-dark.png') }}" alt="logo-dark" height="25">
                                </span>
                            </a>

                            <a href="index.html" class="logo logo-light">
                                <span class="logo-sm">
                                    <img src="{{ asset('admin/assets/images/logo-light.png') }}" alt="logo-sm-light" height="24">
                                </span>
                                <span class="logo-lg">
                                    <img src="{{ asset('admin/assets/images/logo-sm-light.png') }}" alt="logo-light" height="25">
                                </span>
                            </a>
                        </div>
            ...
            <div class="vertical-menu">
                 ...
                 <div class="navbar-brand-box">
                    ...
                    <a href="index.html" class="logo logo-light">
                        <span class="logo-sm">
                            <img src="{{asset('admin/assets/images/logo-sm-light.png')}}" alt="logo-sm-light" height="24">
                        </span>
                        <span class="logo-lg">
                            <img src="{{asset('admin/assets/images/logo-light.png')}}" alt="logo-light" height="22">
                        </span>
                    </a>
                </div>
                ...
                <div class="dropdown px-3 sidebar-user sidebar-user-info">
                    <button type="button" class="btn w-100 px-0 border-0" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                    <img src="{{ asset('admin/assets/images/users/avatar-2.jpg') }}" class="img-fluid header-profile-user rounded-circle" alt="">
                            </div>
                                    ...
                                    <div class="card-body pt-2">
                                        <div class="table-responsive" data-simplebar style="max-height: 358px;">
                                            <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                                <tbody>
                                                    <tr>
                                                        <td style="width: 20px;"><img src="{{asset('assets/images/users/avatar-4.jpg')}}" class="avatar-sm rounded-circle " alt="..."></td>
                                                        <td>
                                            ...
                                            <table class="table align-middle table-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><img src="{{ asset('admin/assets/images/users/avatar-2.jpg') }}" class="avatar-xs rounded-circle me-2" alt="..."> Neal Matthews</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img src="{{ asset('admin/assets/images/users/avatar-3.jpg') }}" class="avatar-xs rounded-circle me-2" alt="..."> Jamal Burnett</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img src="{{ asset('admin/assets/images/users/avatar-4.jpg') }}" class="avatar-xs rounded-circle me-2" alt="..."> Juan Mitchell</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img src="{{ asset('admin/assets/images/users/avatar-5.jpg') }}" class="avatar-xs rounded-circle me-2" alt="..."> Barry Dick</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img src="{{ asset('admin/assets/images/users/avatar-6.jpg') }}" class="avatar-xs rounded-circle me-2" alt="..."> Ronald Taylor</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img src="{{ asset('admin/assets/images/users/avatar-7.jpg') }}" class="avatar-xs rounded-circle me-2" alt="..."> Jacob Hunter</td>
